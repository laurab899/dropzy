...
(function (root, factory) {
    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            ...
            p     = this.createEls('p', {style:'opacity:0; width: 100vw; display: none; visibility: hidden;'}, '');
            input = this.createEls('input', {style: 'type: 'file', multiple: 'multiple', accept: 'image/*'});
